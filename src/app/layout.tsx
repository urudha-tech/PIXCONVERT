      ...
      <body className="min-h-full flex flex-col relative overflow-x-hidden bg-white dark:bg-neutral-950">
        ...
        <div className="pointer-events-none fixed inset-0 z-0 select-none bg-white dark:bg-neutral-950" aria-hidden>
          {[-8, 7, 22, 37, 52, 67, 82, 97, 112, 127, 142].map((top, i) => {
            ...
            const bgRight = `url("data:image/svg+xml,%3Csvg width='120' height='120' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='120' height='120' fill='black'/%3E%3Cpolygon points='0,0 60,60 0,120 22,120 82,60 22,0' fill='white'/%3E%3Cpolygon points='60,0 120,60 60,120 82,120 142,60 82,0' fill='white'/%3E%3C/svg%3E")`
            const bgLeft  = `url("data:image/svg+xml,%3Csvg width='120' height='120' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='120' height='120' fill='black'/%3E%3Cpolygon points='120,0 60,60 120,120 98,120 38,60 98,0' fill='white'/%3E%3Cpolygon points='60,0 0,60 60,120 38,120 -22,60 38,0' fill='white'/%3E%3C/svg%3E")`

            return isAnimated ? (
              /* Clip container handles rotation; inner div animates via translateX (GPU) */
              <div
                key={i}
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    backgroundImage: isRight ? bgRight : bgLeft,
