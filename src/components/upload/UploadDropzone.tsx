  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="sr-only"
        multiple={multiple}
        accept="image/jpeg,image/png,image/bmp,image/gif,image/heic,image/heif,image/avif,image/svg+xml,application/zip,application/x-zip-compressed,.jpg,.jpeg,.png,.bmp,.gif,.heic,.heif,.avif,.svg,.zip"
